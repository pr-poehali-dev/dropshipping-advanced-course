...
const Index = () => {
  ...
  const faq = [
    ...
    },
    {
      ...
      a: "Полный курс, личное наставничество, помощь и поддержка на время обучения."
    },
    {
      q: "Что делать, если возникнут сложности?",
      a: "У вас будет личный наставник, который поможет разобраться с материалом и ответит на любые вопросы."
    }
  ];
            ...
            <div className="space-y-6 md:space-y-8 animate-fade-in">
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                <p className="text-xl md:text-2xl font-semibold text-[#1A1F2C]">
                  Создайте свой B2B-сайт и выходите на сделки от{" "}
      ...
      <section className="py-16 md:py-24 px-4 bg-white">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="mt-12 md:mt-16 p-6 md:p-10 bg-gradient-to-r from-red-50 to-orange-50 border-l-4 border-red-500 rounded-r-2xl animate-pulse">
            ...
            <Button size="lg" className="mt-4 w-full md:w-auto text-base md:text-lg px-6 md:px-8 py-5 md:py-6 font-bold bg-red-600 hover:bg-red-700" onClick={() => window.open('https://t.me/Ivan_936', '_blank')}>
              <Icon name="TrendingUp" className="mr-2 flex-shrink-0" size={20} />
              <span className="hidden md:inline">НЕ ТЕРЯТЬ ДЕНЬГИ — </span>НАЧАТЬ СЕЙЧАС
            </Button>
          </div>
        </div>
      </section>
