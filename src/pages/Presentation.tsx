    ...
    <div className="min-h-screen bg-gradient-to-b from-[#1A1F2C] to-[#0F1419]">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="bg-[#1A1F2C] rounded-2xl p-8 shadow-2xl border border-white/10">
            <div className="mb-8">
              <img 
            ...
            <div className="space-y-6 text-white">
              <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-[#0EA5E9] to-[#9b87f5] bg-clip-text text-transparent">
              ...
              <div className="bg-[#0F1419] rounded-xl p-6 border border-[#0EA5E9]/20">
                <p className="text-lg font-semibold mb-4 text-white">
                  На странице курса вы найдете:
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <Icon name="CheckCircle2" size={24} className="text-[#0EA5E9] flex-shrink-0 mt-0.5" />
                    <span className="text-white/90">Полную программу с модулями по AI</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <Icon name="CheckCircle2" size={24} className="text-[#0EA5E9] flex-shrink-0 mt-0.5" />
                    <span className="text-white/90">Данные и реквизиты, подтверждающие, что мы работаем честно</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <Icon name="CheckCircle2" size={24} className="text-[#0EA5E9] flex-shrink-0 mt-0.5" />
                    <span className="text-white/90">Ответы на все вопросы</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="pt-6">
                ...
                >
                  <Button 
                    size="lg"
                    className="w-full sm:w-auto bg-gradient-to-r from-[#0EA5E9] to-[#9b87f5] hover:opacity-90 text-white text-lg px-8 py-6 font-semibold"
                  >
                    Перейти на сайт
